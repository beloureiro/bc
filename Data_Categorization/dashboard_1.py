...
from Data_Categorization.data_categorization import run_feedback_type_analysis
...
def run_data_categorization():
    ...
    # Adicione esta linha onde você quer que a análise de tipo de feedback apareça
