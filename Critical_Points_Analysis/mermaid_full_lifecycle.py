...
def full_lifecycle_sequence_diagram():
    ...
    st.markdown("<div style='text-align: center;'>⚠️ <strong>Note</strong>: This is the full version of the process. Since there was no opportunity to validate the process steps, there may be some margin for error in modeling this process.</div>", unsafe_allow_html=True)
